...
import messageTransmitterIdl from '../idl/message_transmitter.json' assert { type: 'json' };
import tokenMessengerIdl from '../idl/token_messenger_minter.json' assert { type: 'json' };
