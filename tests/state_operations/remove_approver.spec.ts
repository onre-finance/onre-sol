...
describe("Remove Approver", () => {
    ...
    test("Cannot remove approver that doesn't exist", async () => {
        ...
        ).rejects.toThrow("Instruction 0 failed with custom error code 6000: The provided address is not an approver");
    });
    ...
    test("Cannot remove default pubkey", async () => {
        ...
        ).rejects.toThrow("Instruction 0 failed with custom error code 6001: Invalid approver");
    });
