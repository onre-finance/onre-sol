...
describe("Close dual redemption offer", () => {
    ...
    test("Close multiple dual redemption offers should succeed", async () => {
        ...
        // Create first offer
        await testHelper.program.methods
            .makeDualRedemptionOffer(startTime, endTime, price1, price2, new BN(7000), new BN(0))
            .accounts({
        ...
        // Create second offer
        await testHelper.program.methods
            .makeDualRedemptionOffer(startTime, endTime, price1, price2, new BN(9000), new BN(0))
            .accounts({
